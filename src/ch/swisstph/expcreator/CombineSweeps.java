...
public class CombineSweeps {
    ...
    public void genCombinationList(int sceIdStart) {
        int combinations = 1;
    ...
    public void writeCombinationList(int sceIdStart, String scnListPath) throws Exception {
    ...
    public void readCombinationList(int sceIdStart, String scnListPath) throws Exception {
     ...
     * Throws on failure.
     */
    public int updateDb(String dbUrl, String dbUser) throws Exception {
        int id_db_start = -1;
        ...
        try {
            ...
            for (int i = 0; i < scenarios.length; ++i) {
                if (scenarios[i] != null) {
                    id_loop = scenarios[i].dbScenarios(scenariosSt);
                    if( id_db_start >= 0 && id_loop < id_db_start || id_db_start != -1){
                        id_db_start = id_loop;
                    }
                }
            }
